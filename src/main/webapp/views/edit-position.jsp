...
<body>
	...
	<div class="container">
		<h2>Edit Position</h2>
		<form method="post" action="/recruiter/positions/edit">
			<%
			...
			<input type="text" name="positionName" id="positionName" value="<%=position.getPositionName()%>" required />

			<label for="jobDescription">Job Description:</label>
			<textarea name="jobDescription" id="jobDescription" required><%=position.getJobDescription()%></textarea>

			<button type="submit">Update Position</button>
		</form>
		<a href="/recruiter/searchPositions">Cancel</a>
	</div>
</body>
</html>
